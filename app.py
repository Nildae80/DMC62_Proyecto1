...
# ==============================================================================
# INYECCIÓN DE ESTILOS Y EFECTOS VISUALES (UI/UX DESIGN)
# ==============================================================================
st.markdown("""
    <style>
    /* 1. PALETA DE COLORES Y VARIABLES CORPORATIVAS */
    :root {
        --bg-main: #0B0F19;
    ...
    /* 2. CONFIGURACIÓN GENERAL Y FONDOS CON DEGRADADO */
    .stApp {
    ...
    /* 4. TARJETAS / FORMULARIOS Y CONTENEDORES (Efecto Glassmorphism + Glow) */
    [data-testid="stForm"], div[data-testid="stMetric"], .stDataFrame {
    ...
    /* 5. BOTONES INTERACTIVOS CON EFECTO DE LUZ (HOVER GLOW) */
    ...
    /* 6. INPUTS Y SELECTBOX MODERNIZADOS */
    ...
    /* 7. TIPOGRAFÍA Y TITULARES CON GRADIENTES */
    h1, h2, h3 {
    ...
    /* 8. ANIMACIÓN DE ENTRADA SUAVE (FADE IN) */
...
# JS INTERACTIVO PARA EFECTO DE SEGUIMIENTO DE LUZ (MOUSE GLOW EFFECT)
st.components.v1.html("""
    ...
    parentDoc.addEventListener('mousemove', (e) => {
        ...
        if (!glow) {
            ...
            glow.style.background = 'radial-gradient(circle, rgba(0, 242, 254, 0.06) 0%, rgba(0,0,0,0) 70%)';
            glow.style.borderRadius = '50%';
            glow.style.pointerEvents = 'none';
            glow.style.zIndex = '99999';
            glow.style.transform = 'translate(-50%, -50%)';
            glow.style.transition = 'width 0.2s, height 0.2s';
