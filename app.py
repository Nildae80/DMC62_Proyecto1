...
# ==============================================================================
# INYECCIÓN DE ESTILOS Y EFECTOS VISUALES - PALETA EMPRESARIAL DE ALTO CONTRASTE
# ==============================================================================
st.markdown("""
    <style>
    /* 1. PALETA DE COLORES CORPORATIVA Y ALTO CONTRASTE */
    :root {
        --bg-main: #F8FAFC;              /* Fondo general gris ultraclaro */
        --bg-card: #FFFFFF;              /* Fondo de tarjetas y forms blanco puro */
        --border-card: #E2E8F0;          /* Bordes gris claro definido */
        --primary-blue: #1E3A8A;         /* Azul marino empresarial para encabezados */
        --accent-blue: #2563EB;          /* Azul activo para botones */
        --text-dark: #0F172A;            /* Texto principal (Casi negro / Pizarra) */
        --text-muted: #475569;           /* Texto secundario (Gris oscuro) */
        --shadow-subtle: 0 4px 12px rgba(15, 23, 42, 0.05);
        --shadow-glow: 0 8px 24px rgba(37, 99, 235, 0.18);
    }

    /* 2. FONDO PRINCIPAL Y TEXTO GENERAL */
    .stApp {
    ...
    /* 3. LEGIBILIDAD TOTAL EN TEXTOS, PÁRRAFOS Y ETIQUETAS */
    p, span, label, div, li, .stMarkdown {
        color: var(--text-dark) !important;
        font-weight: 500;
    }

    /* 4. ENCABEZADOS Y TÍTULOS CORPORATIVOS */
    h1, h2, h3, h4 {
    ...
    /* 5. SIDEBAR ESTILIZADO CON ALTO CONTRASTE */
    ...
    /* 6. TARJETAS, FORMULARIOS Y MÉTRICAS (Efecto Elevación + Glow en Hover) */
    [data-testid="stForm"], div[data-testid="stMetric"] {
    ...
    [data-testid="stForm"]:hover, div[data-testid="stMetric"]:hover {
        border-color: var(--accent-blue) !important;
        box-shadow: var(--shadow-glow) !important;
        transform: translateY(-2px);
    }

    /* 7. CAMPOS DE ENTRADA (INPUTS, SELECTBOX, NUMBER INPUTS) */
    ...
    /* 8. TABLAS Y DATAFRAMES NATIVOS CON TEXTO LEGIBLE */
    .stDataFrame {
        background-color: #FFFFFF !important;
        border: 1px solid var(--border-card) !important;
    ...
    /* Force color on Streamlit dataframe text */
    [data-testid="stDataFrame"] * {
        color: var(--text-dark) !important;
    }

    /* 9. BOTONES CON EFECTO DE ILUMINACIÓN Y TRANSMISIÓN DE ENERGÍA */
    ...
    /* 10. ALERTAS E INFORMACIÓN (ST.INFO, ST.WARNING, ST.SUCCESS) */
    .stAlert {
        border-radius: 10px !important;
        font-weight: 600 !important;
    }
...
# JS INTERACTIVO - EFECTO DE SEGUIMIENTO DE LUZ SUTIL (MOUSE GLOW CORPORATIVO)
st.components.v1.html("""
    <script>
    const parentDoc = window.parent.document;
    parentDoc.addEventListener('mousemove', (e) => {
        let glow = parentDoc.getElementById('cursor-glow');
        if (!glow) {
            ...
            glow.style.background = 'radial-gradient(circle, rgba(37, 99, 235, 0.07) 0%, rgba(255,255,255,0) 70%)';
